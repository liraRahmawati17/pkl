...
<body>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">menampilkan data barang</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <div class="form-group">
                                                ...
                                                <input type="text" name="nama_barang" value="{{$produk->nama_barang}}" class="form-control @error('nama_barang') is-invalid @enderror">
                                                @error('nama_barang')
