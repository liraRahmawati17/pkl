                                    ...
                                    <thead>
                                        <form action="{{route('penjualan.update',$penjualan->id)}}" method="post">
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <input type="text" name="qty" value="{{$penjualan->nama}}" class="form-control @error('nama') is-invalid @enderror">
                                                    @error('nama')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="harga" value="{{$penjualan->harga}}"  class="form-control @error('harga') is-invalid @enderror">
                                                    @error('harga')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
