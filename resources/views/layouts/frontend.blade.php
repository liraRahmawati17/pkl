...
<head>
    ...
    <!-- google font -->
    <link href="{{ asset('frontend/https://fonts.googleapis.com/css?family=Open+Sans:300,400,700') }}"
        rel="stylesheet">
    <link href="{{ asset('frontend/https://fonts.googleapis.com/css?family=Poppins:400,700&display=swap') }}"
        rel="stylesheet">
    <!-- fontawesome -->
                        ...
                        <div class="single-product-item">
                            <div class="product-image">
                                <a href="single-product.html"><img
                                        src="{{ asset('frontend/assets/img/products/produk1.png') }}" alt=""></a>
                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    <p>Copyrights &copy; 2021 - <a href="https://imransdesign.com/">Imran Hossain</a>, All Rights
                        Reserved.<br>
